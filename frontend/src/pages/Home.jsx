                    ...
                    {blogs.map((blog, i) => (
                        ...
                        >
                            <div className="h-56 overflow-hidden">
                                <img src={`http://localhost:5001${blog.featured_image}`} alt={blog.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                            </div>
